...
- Record material AI assistance in this file or a more specific document.
- Review, test, and edit generated code before committing it.
- Do not submit operational secrets, personal data, real NFC scan records, or biometric material to an AI tool.
- Preserve prompts and specifications if a spec-driven workflow is used.
